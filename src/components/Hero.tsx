            ...
            <Container className="flex flex-wrap ">
                <div className="flex items-center w-full lg:w-1/2">
                    <div className="max-w-2xl mb-8">
                        ...
                        {/* <Benefit /> */}
                        <div className="flex items-center justify-evenly w-full  border bg-orange rounded-lg p-2 md:p-3 lg:p-4 mt-5 text-center">
                            <p className="flex flex-col items-center justify-center text-xl lg:text-4xl font-bold text-[#fff]">
                                27k+ Cases
                            ...
                            <p className="flex flex-col items-center justify-center text-xl lg:text-4xl font-bold text-[#fff] px-5 md:px-7 lg:px-9">
                                10+ Years
