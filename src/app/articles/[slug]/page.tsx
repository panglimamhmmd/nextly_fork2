...
async function ArticleDetails({ params }: { params: { slug: string } }) {
    ...
    try {
            ...
            <article className="max-w-2xl px-6 py-12 mx-auto space-y-12 dark:bg-gray-100 dark:text-gray-900">
                <div className="w-full mx-auto space-y-4 text-center">
                    ...
                    <p className="text-sm dark:text-gray-600">
                        ...
                        on <ArticleDate date={article.date} />
                    </p>
                </div>
                ...
                <div className="pt-12 border-t dark:border-gray-300">
                    <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="dark:text-gray-600">
                                {article.author.node.description}
                            </p>
                        </div>
                    </div>
                    <div className="flex justify-center pt-4 space-x-4 align-center">
                        <a
                            ...
                            href="#"
                            aria-label="GitHub"
                            className="p-2 rounded-md dark:text-gray-800 hover:dark:text-red-600"
                        >
                            <svg
                                viewBox="0 0 496 512"
        ...
        return <p>Error loading article details.</p>;
    }
}
